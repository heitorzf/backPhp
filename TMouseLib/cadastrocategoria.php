...
if (isset($_POST['pesquisar'])) {
    ...
    if ($resultado) {
        if (mysqli_num_rows($resultado) > 0) {
            ...
            echo "<div class='mensagem erro'>Nenhuma categoria encontrada com esse código.</div>";
        }
    } else {
...
echo "<script>setTimeout(function(){ window.location.href = 'cadastrocategoria.html'; }, 3000);</script>";
?> 